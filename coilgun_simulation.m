...
F = zeros(1,size(x1,2)); % induced force [N]
for i = 2:size(x1,2)
...
xlabel('distance from coil center [stages]')
...
xlabel('distance from start [stages]')
ylabel('acceleration [g]')
grid on
% 